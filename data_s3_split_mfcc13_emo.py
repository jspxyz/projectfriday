...
# save y_train, y_test
with open('./Data_Array_Storage/y_train_mfcc13_axis0_emo.pkl', 'wb') as f:
    pickle.dump(y_train, f)

with open('./Data_Array_Storage/y_test_mfcc13_axis0_emo.pkl', 'wb') as f:
    pickle.dump(y_test, f)

# Pickel the lb object for future use 
with open('./Data_Array_Storage/labels_mfcc13_axis0_emo.pkl', 'wb') as f:
    pickle.dump(lb, f)
...
with open('./Data_Array_Storage/X_train_mfcc13_axis0_emo.pkl', 'wb') as f:
    pickle.dump(X_train, f)

with open('./Data_Array_Storage/X_test_mfcc13_axis0_emo.pkl', 'wb') as f:
