...
with open('./Data_Array_Storage/male_emo_mean.pkl', 'wb') as f:
    pickle.dump(mean, f)

with open('./Data_Array_Storage/male_emo_std.pkl', 'wb') as f:
    pickle.dump(std, f)
...
# save y_train, y_test
with open('./Data_Array_Storage/male_emo_y_train.pkl', 'wb') as f:
    pickle.dump(y_train, f)

with open('./Data_Array_Storage/male_emo_y_test.pkl', 'wb') as f:
    pickle.dump(y_test, f)

# Pickel the lb object for future use 
with open('./Data_Array_Storage/male_emo_labels.pkl', 'wb') as f:
    pickle.dump(lb, f)

# saving X_train and X_test
with open('./Data_Array_Storage/male_emo_X_train.pkl', 'wb') as f:
    pickle.dump(X_train, f)

with open('./Data_Array_Storage/male_emo_X_test.pkl', 'wb') as f:
