...
Labels: Polarity
Datasets created on 20201211 2216
'''
...
# save y_train, y_test
with open('./Data_Array_Storage/y_train_mfcc40_pol_axis0_us.pkl', 'wb') as f:
    pickle.dump(y_train, f)

with open('./Data_Array_Storage/y_test_mfcc40_pol_axis0_us.pkl', 'wb') as f:
    pickle.dump(y_test, f)

# Pickel the lb object for future use 
with open('./Data_Array_Storage/labels_mfcc40_pol_axis0_us.pkl', 'wb') as f:
    pickle.dump(lb, f)
...
with open('./Data_Array_Storage/X_train_mfcc40_pol_axis0_us.pkl', 'wb') as f:
    pickle.dump(X_train, f)

with open('./Data_Array_Storage/X_test_mfcc40_pol_axis0_us.pkl', 'wb') as f:
