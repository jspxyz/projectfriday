...
with open('./Data_Array_Storage/X_train_under.pkl', 'rb') as f:
    X_train_under = pickle.load(f)

with open('./Data_Array_Storage/X_test_under.pkl', 'rb') as f:
    X_test_under = pickle.load(f)

with open('./Data_Array_Storage/y_train_under.pkl', 'rb') as f:
    y_train_under = pickle.load(f)
...
checkpoint_path = "./models_saved/model_a_conv1d_under.h5"
...
model_history=model.fit(X_train_under, 
                        y_train_under,
                        batch_size=16,
                        epochs=150,
...
# with open('./Data_Array_Storage/X_train_under.npy', 'rb') as f:
#     X_train_under = np.load(f, allow_pickle=True)
