...
def create_journal_entries_table(conn, cur):
    query = """
...
class Journal_Entry:
    def __init__(self, results_dict, je_id=None, create_at=None): # date, text_content, text_confidence, text_wordcount, keywords, text_polarity, text_polarity_prob, text_emotion, text_emotion_prob, audio_polarity, audio_polarity_prob, audio_emotion, audio_emotion_prob, entry_filepath, create_at, 
