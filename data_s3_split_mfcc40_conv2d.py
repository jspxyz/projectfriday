'''
Creating Data for Conv2d with mfcc40 features
...
X_train = X_full[:len_train_set]
y_train = y_full[:len_train_set]

X_test = X_full[len_train_set:]
y_test = y_full[len_train_set:]
...
# save y_train, y_test
with open('./Data_Array_Storage/y_train_mfcc40_conv2d.pkl', 'wb') as f:
    pickle.dump(y_train, f)

with open('./Data_Array_Storage/y_test_mfcc40_conv2d.pkl', 'wb') as f:
...
with open('./Data_Array_Storage/X_train_mfcc40_conv2d.pkl', 'wb') as f:
    pickle.dump(X_train, f)

with open('./Data_Array_Storage/X_test_mfcc40_conv2d.pkl', 'wb') as f:
