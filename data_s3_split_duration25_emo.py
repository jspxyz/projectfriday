...
# opening df_features
with open('./Data_Array_Storage/data_features_mfcc40_duration25.pkl', 'rb') as f:
    df_features = pickle.load(f)

# opening df_features_noise as pickle file
with open('./Data_Array_Storage/data_features_noise_mfcc40_duration25.pkl', 'rb') as f:
    df_features_noise = pickle.load(f)

# opening error_list as pickle file
with open('./Data_Array_Storage/error_list_mfcc40_duration25.pkl', 'rb') as f:
...
# save y_train, y_test
with open('./Data_Array_Storage/emo_duration25_axis0_y_train.pkl', 'wb') as f:
    pickle.dump(y_train, f)

with open('./Data_Array_Storage/emo_duration25_axis0_y_test.pkl', 'wb') as f:
    pickle.dump(y_test, f)

# Pickel the lb object for future use 
with open('./Data_Array_Storage/emo_duration25_axis0_labels.pkl', 'wb') as f:
    pickle.dump(lb, f)
...
with open('./Data_Array_Storage/emo_duration25_axis0_X_train.pkl', 'wb') as f:
    pickle.dump(X_train, f)

with open('./Data_Array_Storage/emo_duration25_axis0_X_test.pkl', 'wb') as f:
