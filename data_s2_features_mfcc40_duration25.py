...
with open('./Data_Array_Storage/data_features_mfcc40_duration25.pkl', 'wb') as f:
    pickle.dump(df_features, f)

print('df_features_noise shape: ', np.shape(df_features_noise))
# saving df_features_noise as pickle file
with open('./Data_Array_Storage/data_features_noise_mfcc40_duration25.pkl', 'wb') as f:
    pickle.dump(df_features_noise, f)

print('error_list shape: ', np.shape(error_list))
# saving df_features_noise as pickle file
with open('./Data_Array_Storage/error_list_mfcc40_duration25.pkl', 'wb') as f:
