...
# save y_train, y_test
with open('./Data_Array_Storage/pol_duration5_axis0_us_y_train.pkl', 'wb') as f:
    pickle.dump(y_train, f)

with open('./Data_Array_Storage/pol_duration5_axis0_us_y_test.pkl', 'wb') as f:
    pickle.dump(y_test, f)

# Pickel the lb object for future use 
with open('./Data_Array_Storage/pol_duration5_axis0_us_labels.pkl', 'wb') as f:
    pickle.dump(lb, f)
...
with open('./Data_Array_Storage/pol_duration5_axis0_us_X_train.pkl', 'wb') as f:
    pickle.dump(X_train, f)

with open('./Data_Array_Storage/pol_duration5_axis0_us_X_test.pkl', 'wb') as f:
