...
def get_audio_sentiment_pol(path_to_audio_file):
    ...
    # print('audio_pol_probability.argmax: ', prob_index)
...
# debugging print code below
    # print('-'*10)
    # print(type(s2t_results))
    # print(len(s2t_results))
    # print('-'*10)

    # print(s2t_results)
    # print('-'*10)
    # print(s2t_results['results'])
    # print(s2t_results['results'][0])
    # print(s2t_results['results'][0]['alternatives'])
    # print(s2t_results['results'][0]['alternatives'][0])
    # print(s2t_results['results'][0]['alternatives'][0]['transcript'])
    # print('-'*10)